...
async function main() {
    try {
        ...
        const connectionProfilePath = path.resolve(__dirname, '..', 'CidadaoConnection.json');
        ...
        const connectionOptions = { wallet, identity: 'Cidadao Admin', discovery: { enabled: true, asLocalhost: true } };
        ...
        await contract.submitTransaction('createRelation', '101', '001', '001', '001', '001', '001', '001', '002');
...
void main();
//# sourceMappingURL=createRelation.js.map