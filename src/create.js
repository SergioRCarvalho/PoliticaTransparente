    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    walletPath = path.join(process.cwd(), 'CidadaoWallet');
                ...
                case 3:
                    network = _a.sent();
                    contract = network.getContract('voto-contract');
                    // Submit the specified transaction.
                    return [4 /*yield*/, contract.submitTransaction('createVoto', '007', '1', '004', '0024')];
                case 4:
                    // Submit the specified transaction.
                    _a.sent();
